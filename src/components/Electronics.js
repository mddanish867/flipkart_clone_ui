  ...
  useEffect(() => {
    const getData = async () => {
      const response = await axios.get(
        "https://localhost:7274/api/Account/RetrieveSubCategoryDetails/subcategories?Category=Electronics"
      );
                      ...
                      <ul className="list-menu">
                        {userdata.map((data) => {
                          for (let i = 0; i < data.subCategory.length; i++) {
                            ...
                            } else if (data.subCategory === "Laptop") {
                              return (
                                <>
                                  <li className="nav-item" role="presentation">
                                    <Link
                            ...
                            } else if (data.subCategory === "Mobile") {
                              return (
                                <>
                                  <li className="nav-item" role="presentation">
                                    <Link
                            ...
                            } else if (data.subCategory === "Tablet") {
                              return (
                                <>
                                  <li className="nav-item" role="presentation">
                                    <Link
