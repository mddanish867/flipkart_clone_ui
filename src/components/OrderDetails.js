            ...
            <div className="container">
              <div className="row">
                <div className="col-4">
                  ...
                  <p
                    className="mx-4 text-justify my-2"
                    align="justify"
                    style={{ fontSize: "14px" }}
                  >
                    {custAddress}
            ...
            return (
              <div className="row gx-4">
                          ...
                          <div className="card-body">
                            <div className="row">
                              ...
                              <div className="col-md-6 col-lg-6 col-xl-6">
                                ...
                                >
                                  Color:{" "}
                                  <span className="mx-1"> {data.color}</span>
                                </div>
                                <span
                                  align="justify"
                      ...
                      >
                        {status === "Cancelled" ? 
                         ...
                         <div className="d-flex flex-row justify-content-between align-items-center">
                           <div className="d-flex flex-column align-items-start text-success">
                             <span
                           ...
                           <span
                             style={{ fontSize: "12px", fontWeight: "500", color:"red"}}
                           >
                             Cancelled
                           </span>
                         </div>
                       ...
                       <div className="d-flex flex-row justify-content-between align-items-center">
                         ...
                         <div className="d-flex flex-column justify-content-center text-success">
                           <span
                             style={{ fontSize: "12px", fontWeight: "500" }}
                           >
                             Shipped
                ...
                <div className="col-lg-2 mb-4">
                  <div
                    className="card"
                    style={{ borderColor: "white", marginLeft: "-200px" }}
                  >
                    <div className="card-body">
                      {status === "Delivered" ? (
                        <ul className="list-group list-group-flush">
