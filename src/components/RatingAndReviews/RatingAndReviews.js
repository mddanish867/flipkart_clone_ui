...
const API_BASE = process.env.REACT_APP_API_URL || "https://localhost:7274";
...
export default function RatingAndReviews() {
  ...
  const getOrderData = async () => {
    try {
      const response = await axios.get(
        `${API_BASE}/api/Products/PurchasedProductRatings/productId/${params.productId}/rating-reviews`
      );
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE}/api/Account/RatingReviews/rating_reviews`, data);
      Swal.fire({
        position: "center",
        icon: "success",
    ...
    return (
      <div className="form-group">
        <textarea
          ...
          style={{ height: "65px", borderRadius: "0 0 0 0" }}
          onChange={(e) => setReviewCustName(e.target.value)}
        ></textarea>
      </div>
    );
  };
        ...
        <div className="col-12" style={{ marginTop: "-7px" }}>
                      ...
                      <div className="card-body">
                        ...
                        {getOrders.map((data) => {
                          ...
                          return (
                            ...
                            >
                              <div className="row" style={{ marginLeft: "855px" }}>
                                <div className="col-md-6 col-lg-6 col-xl-6">
                                  <div className="d-flex flex-row" style={{ width: "190px" }}>
                                    <span
                                      style={{
                                        fontWeight: "600",
                                        fontSize: "14px",
          ...
          <div style={{ display: "flex", marginTop: "-8px" }}>
            <div
              className="col-3"
              style={{
                boxShadow: "0 2x 4px 0 rgba(0, 0, 0, 0.08)",
                backgroundColor: "#fff",
                marginBottom: "10px",
                marginRight: "11px",
              }}
                ...
                >
                  <span>
                    ...
                    >
                      ...
                      <path d="M9 2l-1.83 2h-3.17c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-12c0-1.1-.9-2-2-2h-3.17l-1.83-2h-6zm3 15c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5 5-5 5 2.24 5 5-2.24 5-5 5z" />
