            ...
            <div className="card">
              <div className="d-flex justify-content-between p-3">
                ...
                <div
                  className="bg-info rounded-circle d-flex align-items-center justify-content-center shadow-1-strong"
                   id="rounded-circle">
                  <p className="text-white mb-0 small"><BsHeart/></p>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="d-flex justify-content-between">
                  <p className="small"><a href="#!" className="text-muted">{data.productName.slice(0, 15)}</a></p>
                  <p className="small text-danger"><s>&#8377; {data.productPrice}</s></p>
                </div>
      
                <div className="d-flex justify-content-between mb-3">
                  <h5 className="mb-0">{data.productDescription.slice(0, 20)}</h5>
                  <h5 className="text-dark mb-0">&#8377; {data.productDiscount}</h5>
                </div>
      
                <div className="d-flex justify-content-between mb-2">
                  <p className="text-muted mb-0">Available: <span className="fw-bold">{data.productQuanitity}</span></p>
