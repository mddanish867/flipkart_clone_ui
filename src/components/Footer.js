...
export default function Foter() {
  return (
    <div>
      <footer className="text-center text-lg-start text-muted bg-dark mt-3" id='Footer'>
  {/* <!-- Section: Links  --> */}
  <section className="my-5" id='Footer'>
      ...
      <div className="row mt-3">
        ...
        <div className="col-12 col-sm-12 col-lg-3">
          ...
          <div className="input-group mb-3">
            <input type="email" className="form-control border" id='btnEmailFooter' placeholder="Email" aria-label="Email" aria-describedby="button-addon2" />
  ...
  <div className="">
    <div className="container">
      <div className="d-flex justify-content-between py-4 border-top">
        {/* <!--- payment ---> */}
        <div>
          <i className="fab fa-lg fa-cc-visa text-white" style={{color:"#2874f0"}}></i>
          <i className="fab fa-lg fa-cc-amex text-white" style={{color:"#2874f0"}}></i>
          <i className="fab fa-lg fa-cc-mastercard text-white" style={{color:"#2874f0"}}></i>
          <i className="fab fa-lg fa-cc-paypal text-white" style={{color:"#2874f0"}}></i>
        </div>
        {/* <!--- payment ---> */}
        ...
        <div className="dropdown dropup">
          ...
          <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="Dropdown">
            ...
            <li style={{color:"#2874f0"}}><hr className="dropdown-divider" /></li>
            <li style={{color:"#2874f0"}}>
